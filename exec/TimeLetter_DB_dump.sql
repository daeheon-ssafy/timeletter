...
(
    ...
    `club_id`      INT               NOT NULL    COMMENT '클럽 ID', 
    `letter_code`  VARCHAR(10)       NOT NULL    COMMENT '레터 코드', 
...
ALTER TABLE alarm COMMENT 'letter_agree';
...
ALTER TABLE alarm
    ADD CONSTRAINT FK_alarm_letter_id_letter_letter_id FOREIGN KEY (letter_id)
